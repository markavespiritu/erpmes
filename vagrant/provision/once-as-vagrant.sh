...
php yii migrate --migrationPath=@vendor/niksko12/yii2-user/migrations <<<"yes"
php yii migrate --migrationPath=@vendor/niksko12/yii2-audit-log/migrations <<<"yes"
php yii migrate --migrationPath=@yii/rbac/migrations <<<"yes"
php yii migrate <<< "yes"
